...
{
	public class DeathCrystal : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Death Crystal");
			AddMapEntry(new Color(255, 70, 233), name);

			dustType = 84;
			drop = ModContent.ItemType<Items.DeathPack.Mineral.DeathCrystal>();
			soundType = 21;
			soundStyle = 1;
			mineResist = 1f;
			minPick = 50;
