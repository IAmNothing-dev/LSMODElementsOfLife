...
{
	public class SwordIceBoss : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Sword of Arianel");  //The (English) text shown below your weapon's name
		}
		...
		public override void SetDefaults()
		{
			...
			item.value = Item.sellPrice(silver: 50); // The value of the weapon in copper coins
			...
			item.crit = 12; // The critical strike chance the weapon has. The player, by default, has 4 critical strike chance
