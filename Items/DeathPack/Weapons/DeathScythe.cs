...
namespace LSMODElementsOfLife.Items.DeathPack.Weapons
{
    public class DeathScythe : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Demon tooth");
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("DeathScytheProj");
            item.damage = 30; // The damage your item deals
            item.melee = true; // Whether your item is part of the melee class
            item.width = 72; // The item texture's width
            item.height = 75; // The item texture's height
            ...
            item.rare = 11; // The rarity of the weapon, from -1 to 13. You can also use ItemRarityID.TheColorRarity
