...
namespace LSMODElementsOfLife.Items.AccessoryBuffClass
{
    public class MageT1 : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddBuff(mod.BuffType("MagicDamageT1"), 6000, true);
            //player.statDefense += 10;
            player.AddBuff(mod.BuffType("DownManacostT1"), 6000, true);
            //player.meleeSpeed -= 0.02f;
            player.AddBuff(mod.BuffType("DownManaRegenT1"), 6000, true);
