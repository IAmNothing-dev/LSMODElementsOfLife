...
namespace LSMODElementsOfLife.Items.AccessoryBuffClass
{
    public class MageT3 : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddBuff(mod.BuffType("MagicDamageT3"), 6000, true);
            //player.statDefense += 10;
            player.AddBuff(mod.BuffType("DownManacostT3"), 6000, true);
            //player.meleeSpeed -= 0.02f;
            player.AddBuff(mod.BuffType("DownManaRegenT3"), 6000, true);
