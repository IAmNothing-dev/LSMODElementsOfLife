...
namespace LSMODElementsOfLife.Items.AccessoryBuffClass
{
    public class MageT4 : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddBuff(mod.BuffType("MagicDamageT4"), 6000, true);
            //player.statDefense += 10;
            player.AddBuff(mod.BuffType("DownManacostT4"), 6000, true);
            //player.meleeSpeed -= 0.02f;
            player.AddBuff(mod.BuffType("DownManaRegenT4"), 6000, true);
