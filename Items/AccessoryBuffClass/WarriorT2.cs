...
{
    public class WarriorT2 : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddBuff(mod.BuffType("MeleeDamageT2"), 6000, true);
            //player.statDefense += 10;
            player.AddBuff(mod.BuffType("DefenseT2"), 6000, true);
            //player.meleeSpeed -= 0.02f;
            player.AddBuff(mod.BuffType("DownMeleeSpeedT2"), 6000, true);
