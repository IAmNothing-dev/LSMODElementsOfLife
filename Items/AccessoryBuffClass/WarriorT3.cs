...
{
    public class WarriorT3 : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddBuff(mod.BuffType("MeleeDamageT3"), 6000, true);
            //player.statDefense += 10;
            player.AddBuff(mod.BuffType("DefenseT3"), 6000, true);
            //player.meleeSpeed -= 0.02f;
            player.AddBuff(mod.BuffType("DownMeleeSpeedT3"), 6000, true);
